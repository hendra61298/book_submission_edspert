...
class _$_DetailBook implements _DetailBook {
  ...
  @override
  String toString() {
    return 'DetailBook(title: $title, subtitle: $subtitle, isbn13: $isbn13, price: $price, image: $image, url: $url, desc: $desc, year: $year, pages: $pages, publisher: $publisher, authors: $authors, rating: $rating)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, subtitle, isbn13, price,
      image, url, desc, year, pages, publisher, authors, rating);
...
abstract class _DetailBook implements DetailBook {
  factory _DetailBook(
      ...
      required final String rating}) = _$_DetailBook;
